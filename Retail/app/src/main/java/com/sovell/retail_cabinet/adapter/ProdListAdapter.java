...
public class ProdListAdapter extends RecyclerView.Adapter implements OnAdapterListener {
    ...
    public ProdListAdapter(Context context, int openType) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(mContext).inflate(R.layout.item_prod, parent, false);
    ...
    public static class ProdHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public ProdHolder(View itemView, OnAdapterListener listener) {
            super(itemView);
